...
Public Class Inventory_form_new
    ...
    Sub RetriveDate(code As String)
        ...
        Select Case Track
            Case 1, 0
                ...
                '        ComboBox1.AddItem(reader3("UOM").ToString)
                '    Loop
                'End If
                'reader3.Close()
    ...
    Private Sub TextBox5_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles TextBox5.KeyDown
        ...
        For Each row As DataGridViewRow In DG1.Rows
            If row.Cells.Item("UOM").Value = ComboBox1.selectedValue Then
        ...
        arg = arg & " VALUES('" & Label6.Text & "','" & TextBox1.Text & "' ,'" & Label5.Text & "' ,'" & items & "' ,'" & ComboBox1.selectedValue & "', '" & Val(TextBox5.Text) & "','" & factor & "','" & Val(TextBox5.Text * factor) & "' , '" & user_id & "', getdate())"
        ...
        arg = arg & " VALUES('" & Label6.Text & "','" & TextBox1.Text & "' ,'" & Label5.Text & "' ,'" & items & "' ,'" & ComboBox1.selectedValue & "', '" & Val(TextBox5.Text) & "','" & factor & "','" & Val(TextBox5.Text * factor) & "' , '" & user_id & "', getdate(),'" & DateTimePicker1.Value.ToString("yyyy/MM/dd") & "')"
        If conn.State = ConnectionState.Closed Then conn.Open()
    ...
    Private Sub ComboBox1_onItemSelected(sender As System.Object, e As System.EventArgs) Handles ComboBox1.onItemSelected
        REM =========================== load UOM

        arg = "SELECT UOM, factor FROM  items_uom WHERE (item = N'" & TextBox2.Text & "') and UOM = '" & ComboBox1.selectedValue & "'"
        Dim cmd3 As SqlCommand = New SqlCommand(arg, conn)
        Dim reader3 As SqlDataReader = cmd3.ExecuteReader()
        If reader3.HasRows = True Then
            reader3.Read()
    ...
    Private Sub TextBox2_OnTextChange(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub TextBox5_OnValueChanged(sender As System.Object, e As System.EventArgs) Handles TextBox5.OnValueChanged

    End Sub

    Private Sub TextBox2_OnValueChanged(sender As System.Object, e As System.EventArgs) Handles TextBox2.OnValueChanged
